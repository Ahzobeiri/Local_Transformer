...
def get_eeg(data_folder, patient_id, db: lmdb.open, file_key_list: list):
    ...
    Parameters:
      ...
      file_key_list (list): A list to collect keys for saved samples.
    """
    ...
    try:
        ...
        outcome = get_outcome(patient_metadata)  # Binary label: 0 (Good) or 1 (Poor)
...
if __name__ == '__main__':
    ...
    # Initialize LMDB (here a map_size of 1TB is allocated; adjust as needed)
    env = lmdb.open(output_db, map_size=1099511627776)
    file_keys = []
